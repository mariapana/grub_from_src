  ...
  static struct symtab tab[] =
    {
      ...
      {"grub_disk_native_sectors", grub_disk_native_sectors, 1},
      ...
      {"grub_dl_ref_count", grub_dl_ref_count, 1},
      ...
      {"grub_file_verifiers", (void *) &grub_file_verifiers, 0},
      ...
      {"grub_printf_fmt_check", grub_printf_fmt_check, 1},
      ...
      {"grub_register_command_lockdown", grub_register_command_lockdown, 1},
      ...
      {"grub_verify_string", grub_verify_string, 1},
